properties = {
    ...
    "用户界面(UserInterface)": {
        ...
        "resize": {"version":"", "value":["none","both","horizontal","vertical"]},
        "ime-mode": {"version":"", "value":["auto","normal","active","inactive","disabled"]}
    },
    "OnlyIE":{
        "filter": {"version":"", "value":["alpha(opacity=50)"]},
